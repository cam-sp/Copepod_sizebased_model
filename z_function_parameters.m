function param=z_function_parameters(P_size_classes, P_min, P_max, Cact_populations, Cact_min, Cact_max,...
    Cpass_populations, Cpass_min, Cpass_max, C_size_classes, nbrFp, nbrD,PPMR)
...
% if nargin==13
%     param.beta_act=PPMR;%10000;%1/(10^-3.66); %active feeders
% end

param.sigma_act=1.5;%2;
% if nargin==13
%     param.sigma_act=PPMR;%10000;%1/(10^-3.66); %active feeders
% end
...
% param.m_cte=m_cte;
param.p=p;
% no_small(param.Wvec<1e-0)=0.3; %!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! oju
...
param.eff=0.67;
% if nargin==13
%     param.eff=PPMR;%10000;%1/(10^-3.66); %active feeders
% end
...
param.kchl=3e-5;%3.8e-4; %attenuation coefficient of Chl plankton
